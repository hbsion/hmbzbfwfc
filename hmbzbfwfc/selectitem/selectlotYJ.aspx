<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="selectlotYJ.aspx.cs" Inherits="UI.selectlotYJ" %>
                                                    ...
                                                    <mastertableview >
                                                        ...
                                                        <Columns >
                                                            <telerik:GridTemplateColumn>
                                                             ...
                                                             <telerik:GridBoundColumn DataField="yjlot_no" HeaderText="原酒批号" ShowSortIcon="true" SortExpression="yjlot_no" ItemStyle-HorizontalAlign="Left" />
                                                                 <telerik:GridBoundColumn DataField="eship_date" HeaderText="入库时间" ShowSortIcon="true" SortExpression="eship_date" DataFormatString="{0:yyyy-MM-dd}" />   
