<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="selectMlot.aspx.cs" Inherits="UI.selectMlot" %>
                                                    ...
                                                    <mastertableview >
                                                        ...
                                                        <Columns >
                                                            <telerik:GridTemplateColumn>
                                                             ...
                                                             <telerik:GridBoundColumn DataField="lot_no" HeaderText="批号" ShowSortIcon="true" SortExpression="批号" ItemStyle-HorizontalAlign="Left" />
                                             
                                                             <telerik:GridBoundColumn DataField="p_no" HeaderText="产品编号" ShowSortIcon="true" SortExpression="p_no" ItemStyle-HorizontalAlign="Left" />
                                                        
                                                            <telerik:GridBoundColumn DataField="pname" HeaderText="产品名称" ShowSortIcon="true" SortExpression="pname" ItemStyle-HorizontalAlign="Left" />
                                                            <telerik:GridBoundColumn DataField="type" HeaderText="产品规格" ItemStyle-HorizontalAlign="Left" />
                                                            <telerik:GridBoundColumn DataField="pr_date" HeaderText="生产日期" ShowSortIcon="true" SortExpression="pr_date" DataFormatString="{0:yyyy-MM-dd}" />   
