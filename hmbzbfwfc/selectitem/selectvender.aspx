<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="selectvender.aspx.cs" Inherits="UI.selectvender" %>
                                                    ...
                                                    <mastertableview >
                                                        ...
                                                        <Columns >
                                                            <telerik:GridTemplateColumn>
                                                             ...
                                                             <telerik:GridBoundColumn DataField="cu_no" HeaderText="供应商编号" ShowSortIcon="true" SortExpression="cu_no" ItemStyle-HorizontalAlign="Left" />
                                                         
                                                         
                                                            <telerik:GridBoundColumn DataField="cu_name" HeaderText="供应商名称" ShowSortIcon="true" SortExpression="cu_name" ItemStyle-HorizontalAlign="Left" />
                                                          
                                                          <telerik:GridBoundColumn DataField="province" HeaderText="省份/地区" ShowSortIcon="true" SortExpression="province" ItemStyle-HorizontalAlign="Left" />
                                                          <telerik:GridBoundColumn DataField="city" HeaderText="城市" ShowSortIcon="true" SortExpression="city" ItemStyle-HorizontalAlign="Left" />
