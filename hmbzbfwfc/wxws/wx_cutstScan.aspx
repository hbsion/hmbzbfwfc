<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wx_cutstScan.aspx.cs" Inherits="UI.wxws.wx_cutstScan" %>
    ...
    <script type="text/javascript">
        ...
        function layerOpenWin(type) {
            ...
            if (type == "5") {
                ...
                onSelect("选择调拨接收门店", "select_salcu.aspx", '100%', '85%');
            }
        ...
        function addData(xtcu_no) {
            ...
            //判断元素是否为空
            if (nst_no.length == 0) {
                layer.tips("请选择接收门店", $("#txtnst_no"), { tips: 1, icon: 5 });
                return;
            }
            ...
            $.ajax({
                ...
                cache: false,
                async: false,
                data: { "cu_no": encodeURIComponent(xtcu_no), "optype": "cutstScan", "snno": barcode, "ship_no": shipNo, "nst_no": nst_no },
                dataType: "json",
                timeout: 30000,
        ...
        <div data-role="page" id="menu" style="position: relative; background-color: #ffffff">
            ...
            <div data-role="content">
               ...
               <%-- <div class="ub notOrdership">
                    <label for="cusInfo">
                        门店:</label>
                    <input type="text" style="margin-bottom: 0" placeholder="*选择调拨接收门店" runat="server" name="nstInfo" id="nstInfo" />
                    <input value="接收门店" onclick="layerOpenWin('5')" type="button" id="select_st2" />
                ...
                <div class="ub notOrdership">
                    ...
                    <input value="接收门店" onclick="layerOpenWin('5')" type="button" id="select_cus" />
