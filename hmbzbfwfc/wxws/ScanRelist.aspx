<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScanRelist.aspx.cs" Inherits="UI.wxws.ScanRelist" %>
    ...
    <script>
        ...
        function loadDataList() {
            ...
            $.ajax({
                type: "post",
                url: url,
                data: { "key": "ScanRelist", "query": "", "PageIndex": 1, "PageSize": 120, "wheresql": wheresql },
                timeout: 30000,
                datatype: "json",
...
<body>
    <form id="Form2" runat="server">
        ...
        <div class="container-fluid">
            ...
            <div class="row" style="height: 40px; background-color: #4F81BD; text-align: center; line-height: 40px; color: #ffffff;">
                ...
                <div class="col-xs-10">退货扫描明细 </div>
    ...
    <div class="container"  id="div_{$T.row.fid}" style="margin-bottom:5px; background:#eeeeee" >
          ...
          <div class="row"   style="margin:0px 5px 5px 5px;" >
	            ...
	            <div  >
                  退货客户：  {$T.row.cu_no}  {$T.row.cu_name}
		         </div>	

	            <div  >
                  退货产品：  {$T.row.p_no}  {$T.row.pame}
		         </div>		
