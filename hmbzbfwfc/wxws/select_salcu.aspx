<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="select_salcu.aspx.cs" Inherits="UI.wxws.select_salcu" %>
    ...
    <script>
        ...
        function loadCus(pageIndex) {
            ...
            $.ajax({
                ...
                type: "post",
                data: { "key": "cust", "query": queryText, "PageIndex": pageIndex, "PageSize": 20,"cu_no":username},
                dataType: "json",
