<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScanShiplist.aspx.cs" Inherits="UI.wxws.ScanShiplist" %>
...
<head>
    ...
    <script>
        ...
        function loadDataList() {
            ...
            var wheresql = " pda_no='" + user_id + "'";

            var url = "../App/appListOf.ashx";
            $.ajax({
                type: "post",
                url: url,
                data: { "key": "ScanShiplist", "query": "", "PageIndex": 1, "PageSize": 120, "wheresql": wheresql },
                timeout: 30000,
                datatype: "json",
...
<body>
    <form id="Form2" runat="server">
        ...
        <div class="container-fluid">
            ...
            <div class="row" style="height: 40px; background-color: #4F81BD; text-align: center; line-height: 40px; color: #ffffff;">
                ...
                <div class="col-xs-10">出货扫描明细 </div>
    ...
    <div class="container"  id="div_{$T.row.fid}" style="margin-bottom:5px; background:#eeeeee" >
          ...
          <div class="row"   style="margin:0px 5px 5px 5px;" >
	            ...
	            <div  >
                  出货客户：  {$T.row.cu_no}  {$T.row.cu_name}
		         </div>	
		            <div  >
                 出货产品：  {$T.row.p_no}  {$T.row.pame}
		         </div>	
