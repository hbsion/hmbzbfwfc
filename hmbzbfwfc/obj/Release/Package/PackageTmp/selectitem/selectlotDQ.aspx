<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="selectlotDQ.aspx.cs" Inherits="UI.selectlotDQ" %>
                                                    ...
                                                    <mastertableview >
                                                        ...
                                                        <Columns >
                                                            <telerik:GridTemplateColumn>
                                                             ...
                                                             <telerik:GridBoundColumn DataField="dqlot_no" HeaderText="大曲批号" ShowSortIcon="true" SortExpression="dqlot_no" ItemStyle-HorizontalAlign="Left" />
                                                                 <telerik:GridBoundColumn DataField="eship_date" HeaderText="出曲时间" ShowSortIcon="true" SortExpression="eship_date" DataFormatString="{0:yyyy-MM-dd}" />   
