<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="selectlotHH.aspx.cs" Inherits="UI.selectlotHH" %>
                                                    ...
                                                    <mastertableview >
                                                        ...
                                                        <Columns >
                                                            <telerik:GridTemplateColumn>
                                                             ...
                                                             <telerik:GridBoundColumn DataField="hhlot_no" HeaderText="混合酒批号" ShowSortIcon="true" SortExpression="hhlot_no" ItemStyle-HorizontalAlign="Left" />
                                                                 <telerik:GridBoundColumn DataField="ship_date" HeaderText="混合时间" ShowSortIcon="true" SortExpression="eship_date" DataFormatString="{0:yyyy-MM-dd}" />   
