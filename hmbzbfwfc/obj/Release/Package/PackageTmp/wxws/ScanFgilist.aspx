<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScanFgilist.aspx.cs" Inherits="UI.wxws.ScanFgilist" %>
    ...
    <script>
        ...
        function loadDataList() {
            ...
            $.ajax({
                type: "post",
                url: url,
                data: { "key": "ScanFgilist", "query": "", "PageIndex": 1, "PageSize": 120, "wheresql": wheresql },
                timeout: 30000,
                datatype: "json",
    ...
    <form id="Form2" runat="server">
        ...
        <div class="container-fluid">
            ...
            <div class="row" style="height: 40px; background-color: #4F81BD; text-align: center; line-height: 40px; color: #ffffff;">
                ...
                <div class="col-xs-10">入库扫描明细 </div>
