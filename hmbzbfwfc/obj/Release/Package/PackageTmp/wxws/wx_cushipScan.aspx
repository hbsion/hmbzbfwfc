<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wx_cushipScan.aspx.cs" Inherits="UI.wxws.wx_cushipScan" %>
    ...
    <script type="text/javascript">
        ...
        function addData(xtcu_no) {
         ...
         //   var po_no = $("#selectOrderPro").val();
            ...
            if (phone.length < 7) {
                layer.tips("请输入消费者电话", $("#phone"), { tips: 1, icon: 5 });
                return;
            }
            ...
            $.ajax({
                ...
                async: false,
                data: {
                    "cu_no": encodeURIComponent(xtcu_no), "optype": "cushipScan", "snno": barcode, "ship_no": shipNo,
                     "delyn": delyn, "user_id": user_id, "phone": phone        
                },
                dataType: "json",
                timeout: 30000,
        ...
        <div data-role="page" id="menu" style="position: relative; background-color: #ffffff">
            ...
            <div data-role="content">
                ...
                <div class="ub">
                    <label for="shipNo">
                        手机号:</label>
                    <input type="text" style="margin-bottom: 0" placeholder="*必填(消费者手机号)" runat="server" name="phone" id="phone" />
                </div>
                <div class="ub">
                    <label for="barcode">
                        条码:</label>
