<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Acuretj.aspx.cs" Inherits="UI.Acuretj" %>
...
id=A1 href="" 
target=_blank>下级退货统计</A></SPAN> </DIV>
...
<UL id=htmlDiv>
   ...
   <DIV class=org style="font-size:12pt">产品编号：<%#Eval("p_no")%>   </DIV> 
   <DIV class=org style="font-size:12pt">产品名称：<%#Eval("pname")%> </DIV> 
  <DIV class=org style="font-size:12pt">退货数量：<%#Eval("reqty")%> </DIV>
  <DIV class=org style="font-size:12pt">退往客户：<%#Eval("xtcu_no")%> 退货客户：<%#Eval("cu_no")%> </DIV>
