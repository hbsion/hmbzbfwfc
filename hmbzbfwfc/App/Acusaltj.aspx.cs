...
namespace UI
{
    public partial class Acusaltj : System.Web.UI.Page
    {
        protected int i = 0;
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
           ...
           this.awards.DataSource = DbHelperSQL.Query("exec psal_cusatj  '" + cu_no + "','" + xtp_no + "','" + txtdatef.SelectedDate.Value.ToString() + "','" + txtdatet.SelectedDate.Value.ToString() + "' "); 
