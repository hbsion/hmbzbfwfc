...
namespace UI
{
    public partial class Acushiplist : System.Web.UI.Page
    {
        protected int i = 0;
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            if (scode.Length > 0)
            {
                strfindstr = strfindstr + "  and  (a.p_no like '%" + scode + "%' or a.pname like '%" + scode + "%' or a.cu_no like '%" + scode + "%' or a.cu_name like '%" + scode + "%')";

            }


            string strsql = " select a.*    from sal_cuship  a  " + strfindstr;
