<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Acusaltj.aspx.cs" Inherits="UI.Acusaltj" %>
...
id=A1 href="" 
target=_blank>销售统计表</A></SPAN> </DIV>
...
<UL id=htmlDiv>
  ...
  <DIV class=org style="font-size:12pt">出货数量：<%#Eval("shipqty")%> </DIV>
  <DIV class=org style="font-size:12pt">终端销售数量：<%#Eval("salqty")%> </DIV>
