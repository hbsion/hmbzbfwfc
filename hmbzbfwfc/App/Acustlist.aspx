<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Acustlist.aspx.cs" Inherits="UI.Acustlist" %>
...
<UL id=htmlDiv>
  ...
  <DIV class=org style="font-size:12pt">经销商编号：<%#Eval("cu_no")%> </DIV>
   <DIV class=org style="font-size:12pt">产品编号：<%#Eval("p_no")%> </DIV> 
  <DIV class=org style="font-size:12pt">产品名称：<%#Eval("pname")%> </DIV>
  <DIV class=org style="font-size:12pt">库存数量：<%#Eval("stqty")%> </DIV>
