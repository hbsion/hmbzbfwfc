...
using brclass = marr.BusinessRule.brCuSaleScan;
using entity = marr.DataLayer.sal_cusale;
...
namespace UI.app
{
    ...
    public class AppCuSale : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string shipcu_name = context.Request["shipcu_name"];
            string chetel = context.Request["chetel"];
            string chetype = context.Request["chetype"];
            ...
            using (brCustomer br = new brCustomer())
            {
                ...
                if  (mycust!=null)
                {
                    ...
                    using (brclass brcufgi = new brclass())
                    {
                        ...
                        newship.chetel = chetel;
                        newship.chetype = chetype;
